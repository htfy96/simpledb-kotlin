 ...
 */
(private val ti: TableInfo, private val tx: Transaction) {
    private val filename: String
    private var rp: RecordPage? = null
    private var currentblknum: Int = 0
    ...
    private fun moveTo(b: Int) {
        if (rp != null)
            rp!!.close()
        currentblknum = b
        val blk = Block(filename, currentblknum)
        rp = RecordPage(blk, ti, tx)
    }
